...
##########
# ConfigureClient() used for agent instype
##########
ConfigureClient()
{
    IP={{siem_ip}}
...
main()
{
    ...
    $ECHO "1- installing by default $INSTYPE version"
